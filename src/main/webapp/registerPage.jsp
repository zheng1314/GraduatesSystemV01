...
<div class="container1">
    <div class="row">
		...
		<div class="form-group">
                    <input type="password" name="userpwd1"class="form-control" id="inputPassword4" placeholder="再次输入密码" required="required">
                </div>
                <div class="form-group">
                    
                    <a href="loginPage.jsp"><span class="text">返回登录</span></a>
