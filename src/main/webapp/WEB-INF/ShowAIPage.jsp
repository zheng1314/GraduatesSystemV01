        ...
        <div class="mid-col-container">
            <nav class="navbar navbar-default " id="nav-layout" role="navigation">
                ...
                <ul class="nav navbar-nav pagination-lg">
                    ...
                    <li class="active"><a href="/ShowServlet?action=AI">获奖信息表</a></li>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="award" placeholder="奖项">
                                    </div>
                                </div>
...
<script>
                ...
                },
                {
                    ...
                    "render": function (a, b, c, d) {
                        var context =
                            {
                                func: [
                                    {"name": "修改", "fn": "edit(\'" + c.sid + "\',\'" + c.major + "\',\'" + c.award + "\')", "type": "primary"},
    ...
    function ajax(obj) {
        var url ="/ShowAIServlet?action=add" ;
        if(editFlag){
            url = "/ShowAIServlet?action=edit";
        }
        $.ajax({
            url:url ,
            data: {
