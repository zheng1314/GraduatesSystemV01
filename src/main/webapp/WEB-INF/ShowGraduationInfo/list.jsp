...
<%@ page import="com.school.model.graduation_info" %><%--
...
<%
    ...
    if (!searchValue.equals("")) {
        ...
        sArray.add(" employment like '%" + searchValue + "%'");
    ...
    List<graduation_info> graduationInfos = new ArrayList<graduation_info>();
    ...
    try {
        if(dbConn != null) {
            ...
            while (resultSet.next()) {
                ...
                graduationInfo.setGender(resultSet.getString("gender"));
                graduationInfo.setEmployment(resultSet.getString("employment"));
                graduationInfo.setMajor(resultSet.getString("major"));
                graduationInfo.setSid(resultSet.getString("sid"));

                graduationInfos.add(graduationInfo);
            }
