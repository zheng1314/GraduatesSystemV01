...
import com.school.utils.Save2DB;
import com.school.utils.SaveDE2DB;
...
public class UploadExcelFileServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String savePath = this.getServletContext().getRealPath("/WEB-INF/UploadExcelFile");
        //上传时生成的临时文件保存目录
        ...
        try{
            ...
            for(FileItem item : list){
                ...
                if(item.isFormField()){
                    ...
                    //SaveDE2DB saveDE2DB = new SaveDE2DB();
                    //System.out.println(realSavePath + "/" + saveFilename);
                    //saveDE2DB.save(realSavePath + "/" + saveFilename);
                    Save2DB save2DB = new Save2DB();
                    save2DB.save(realSavePath + "/" + saveFilename, action, username);
