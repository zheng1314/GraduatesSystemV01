...
import com.school.utils.po.DateJsonValueProcessor;
import com.school.utils.po.JsonPropertyFilter;
import com.school.utils.po.ChartBar;
import com.school.utils.po.ChartPie;
import com.school.utils.po.Datasets;
/**
...
//		System.out.println("，变量值等于：" + Arrays.toString(arr));
    ...
    public static JSONObject generateObjListToChartBar(List objList) throws IllegalArgumentException, Exception{
        ...
        String lab = "不知道什么鬼？"; //ParamUtil.getChartLabels();  获取label对应字段
